...
package com.dishatech.ml

import com.dishatech.ml.{AnomalyDetection, FeaturesParser}
...
object MainAnomalyDetection {
  ...
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setAppName("AnomalyDetection").setMaster("local").set("spark.executor.memory","1g")
